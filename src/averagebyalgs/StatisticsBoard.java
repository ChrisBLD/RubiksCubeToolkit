...
public class StatisticsBoard {
	...
	public void processResults(Map<Double, String> results, ArrayList<ImageView> cubieArray, Group cubieG) {
	...
	ScrambleManager sm = new ScrambleManager(new Group(), cubieArray, cubieG);
	
	for (Map.Entry<Double, String> entry : results.entrySet()) {
		cubieArray = sm.submitted(entry.getValue());
